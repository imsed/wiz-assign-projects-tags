...
parser=argparse.ArgumentParser(
    description='''Assign  AWS subscriptions based on tags to wiz Projects ''',
    epilog="""All is well that ends well.""")
parser.add_argument('--dry-run', choices =['yes','no'], default='no', help='dry run, will not create new Wiz project and will not assign  AWS subscriptions to WIZ projects')
...
SCRIPT_NAME = "Create Wiz Projects and assign AWS subscriptions based on Tags"
SCRIPT_DESCRIPTION = """DESCRIPTION:\n  - This script will create new Wiz projects  based on  subscription Tags\n  - And also assign  AWS subscriptions to Wiz projects based on Tags"""
(
    WIZ_API_URL,
    WIZ_CLIENT_ID,
    WIZ_CLIENT_SECRET,
...
def get_subs_with_tag_key ()-> list:
    ...
    print("Getting AWS subscriptions list")
...
def add_sub_to_project(project_id:str, cloudAccounts_list:list)-> None:
    """
    A wrapper around the query_wiz_api function
    That adds AWS subscriptions to a project
    Parameters:
        - project_id: the UID of the project we want to add AWS subscriptions to
        - cloud_accounts: the UIDs of the clound accounts/AWS subscriptions we want to add to the project
    Returns:
        - none
    """
...
def get_subs_tag_value(subs_nodes:list)-> list:
    """
    Processes the list of AWS subscriptions
    Parameters:
        - subs_nodes: A List of Wiz AWS subscriptions
    Returns:
        - subs_list : list of AWS subscriptions. Each subscription is a dictionary of name, id and tag_key
        - tag_value_list : The tag value of tagged AWS subscriptions with tag_key
    """
    subs_list = []
    tag_value_list =[]
...
def main():
    ...
    # Get the list of AWS subscriptions tagged with tag_key
    ...
    # The script will keep any existing subscription associated with project_name. It will only add new AWS subscriptions to it and doesn't wipe existing ones
