...
parser=argparse.ArgumentParser(
    description='''Assign  GCP subscriptions based on tags to wiz Projects ''',
...
SCRIPT_NAME = "Create Wiz Projects and assign GCP subscriptions based on Tags"
SCRIPT_DESCRIPTION = """DESCRIPTION:\n  - This script will create new Wiz projects  based on  subscription Tags\n  - And also assign  GCP subscriptions to Wiz projects based on Tags"""
(
    WIZ_API_URL,
    WIZ_CLIENT_ID,
    WIZ_CLIENT_SECRET,
...
def get_subs_with_tag_key ()-> list:
    ...
    print("Getting GCP subscriptions list")
...
def add_sub_to_project(project_id:str, cloudAccounts_list:list)-> None:
    """
    A wrapper around the query_wiz_api function
    That adds GCP subscriptions to a project
    Parameters:
        - project_id: the UID of the project we want to add GCP subscriptions to
        - cloud_accounts: the UIDs of the clound accounts/GCP subscriptions we want to add to the project
    Returns:
        - none
    """
...
def get_subs_tag_value(subs_nodes:list)-> list:
    """
    Processes the list of GCP subscriptions
    Parameters:
        - subs_nodes: A List of Wiz GCP subscriptions
    Returns:
        - subs_list : list of GCP subscriptions. Each subscription is a dictionary of name, id and tag_key
        - tag_value_list : The tag value of tagged GCP subscriptions with tag_key
    """
    subs_list = []
    tag_value_list =[]
...
def main():
    ...
    # Get the list of GCP subscriptions tagged with tag_key
    ...
    # The script will keep any existing subscription associated with project_name. It will only add new GCP subscriptions to it and doesn't wipe existing ones
